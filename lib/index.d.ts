...
declare type _Chain<T extends _ALLOWED_TYPES> =
  T extends 'string' ? _String
  : T extends 'number' ? _Number
  : T extends 'array' ? _Array
  : T extends 'object' ? _Object
  : T extends 'boolean' ? _Boolean
  : T extends 'date' ? _Date
  : T extends 'bigint' ? _Bigint
  : T extends 'undefined' ? _Undefined
  : T extends 'null' ? _Null
  : T extends 'NaN' ? _NaN
  : T extends 'symbol' ? _Symbol
  : T extends 'function' ? _Function
  : T extends 'regex' ? _Regex
  : never
 ...
 * 
 */
export declare function ESTest<T extends _ALLOWED_TYPES>(input: unknown, type: T, pubMsg?: string): _Chain<T>
