...
const _log = {
  ...
  errArg1st: (tokenType, input) => console.log(` ✅ Expected 1st Argument (input): '${tokenType}' \n ❌ Received 1st Argument (input): '${getTokenType(input)}'`, input),
}
